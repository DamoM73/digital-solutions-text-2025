...
A mock-up on its own shows what the interface looks like. **Annotations** explain the thinking behind the design — why elements are placed where they are, which success criteria they address, and how usability principles are applied. The QCAA syllabus explicitly identifies annotations as a specific language feature for communicating in Digital Solutions.
...
:::{admonition} Example
:class: tip
A weak annotation says: *"Navigation bar at the top."*
...
In IA2, annotated mock-ups form part of the evidence for developing possible solutions. Responses must show work in progress — earlier iterations of components with annotations identifying possible solutions for user interfaces, data, and programmed components.
...
Including earlier iterations of UI components alongside the final version — with annotations identifying what was refined and why — creates clear evidence of design thinking across the development process.

:::{admonition} Word count
:class: note
Mock-up images themselves are excluded from the word count. However, annotations on mock-ups *are* included in the word count. Plan your annotations carefully — they need to be specific and purposeful, not exhaustive.
:::